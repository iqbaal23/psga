        ...
        <div class="col-12">
            ...
            <div class="panel">
                ...
                <div class="panel-body">
                    <form action="{{ route('editartikel', $data->id) }}" method="post" enctype="multipart/form-data">
                    {{ csrf_field() }}
                        {{ method_field('PATCH') }}
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="judul_artikel" id="summernote"
                                              data-plugin="summernote" rows="3"><?= $data->judul_artikel ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="isi" id="summernotes"
                                              data-plugin="summernote" rows="3"><?= $data->isi ?></textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Upload Foto</label>
                                    <input type="file" name="foto" id="input-file-max-fs" data-plugin="dropify" src="{{asset('public/foto-artikel/'.$data->foto)}}"
