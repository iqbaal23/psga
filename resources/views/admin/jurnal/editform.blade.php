        ...
        <div class="panel-body container-fluid">
            <div class="row row-lg">
                <div class="col-md-12 col-lg-12">
                    ...
                    <h4>Tambah Jurnal</h4>
                    <form action="{{ route('editjurnal', $data->id) }}" method="post" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" readonly value="{{ $data->author }}"
                                           name="author">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <textarea type="text" name="judul" id="summernote"
                                              data-plugin="summernote" rows="3">{{ $data->judul }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
